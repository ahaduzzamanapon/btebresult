      ...
      <div class="video-overlay header-text">
          <div class="caption">
              ...
              <div class="bgb">
                ...
                <button class="btn btn-primary mx-2" onclick="openCity('Paris')">Employee</button>
                <button class="btn btn-primary mx-2" onclick="openCity('Tokyo')">Manager</button>
              </div>
              ...
              <div id="Paris" class="w3-container city" style="display:none">
                <div class="card text-white bg-primary " style="max-width: 100%;">
                  ...
                  <div class="card-body">
                    <form action="{{ url('/employeelogin') }}" method="post">
                      @csrf
                      <div class="fromi mb-2">
                        <div class="form-holder">
                          <label for="password"  style="color: white;"> Email </label>
                          
                            <input type="number"  style="color: rgb(0, 0, 0);" class="form-control inputa" id="email" name="email" placeholder="Email" required>
                      ...
                      <div class="fromi mb-2">
                        <div class="form-holder">
                          <label for="password"   style="color: white;"> Password </label>
                            ...
                            <input type="password" style="color: rgb(0, 0, 0);" class=" inputa form-control " id="password" name="password" placeholder="Password" required>
                      ...
                      <div class="fromi mb-2">
                        <div class="form-holder">
                          <label for="password"  style="color: white;"> Email </label>
                            ...
                            <input type="email" class="form-control inputa" id="email" name="email" placeholder="Email" required>
                      ...
                      <div class="fromi mb-2">
                        <div class="form-holder">
                          <label for="password"   style="color: white;"> Password </label>
                            ...
                            <input type="password" class="form-control inputa" id="password" name="password" placeholder="Password" required>
                            
                          </label>
                        </div>
                        
                      </div>
                      <button class="btn btn-dark btn-lg" type=""><a href="{{'/managerdashboard'}}"> Enter</a></button>
