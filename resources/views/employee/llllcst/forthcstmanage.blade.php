    ...
    <div id="app">
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                ...
                @include('employee/llllcst/sidebar-menu')
                {{--  menu end  --}}
  ...
  document.body.innerHTML = oldContent;
        ...
        <tbody>
            ...
            <tr>
                ...
                @php
                $fees= DB::table('fees')->where('teqnology', '=', 'forthcst')->first();
if(!$data->result){
...
<td class="actiont">@if ($data->admit)
    ...
    @endif</td>
                ...
                <td class="actiont">
                    <a href="{{ '/editforthcst/'.$data->roll }}" class="btn btn-success my-1">Edit</a>
                    <a href="{{ '/delletforthcstdata/'.$data->roll }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger my-1">Delete</a>
