...
@endif
  ...
  <form action="{{ url('/editforthcstresult/'.$showdata->roll) }}" enctype="multipart/form-data" method="post">
    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($showdata->midresult){{'Allready Uploaded'}}@endif
                                        <br>
                                        <input type="file" name="midresult"  id="midresult"><br>
                                        
                                        </div>
                                        <div class="form-group">
                                            <label for="comment">admit card pdf</label><br>
                                            @if($showdata->admit){{'Allready Uploaded'}}@endif
                                        <br>
