  ...
  document.body.innerHTML = oldContent;
        ...
        <tbody>
            ...
            <tr>
                ...
                @php
                $fees= DB::table('fees')->where('teqnology', '=', 'secondcst')->first();
if(!$data->result){
...
<td>@if ($data->admit)
    ...
    @endif</td>
                ...
                <td class="actiont">
                    <a href="{{ '/editsecondcst/'.$data->roll }}" class="btn btn-success my-1">Edit</a>
                    <a href="{{ '/delletsecondcstdata/'.$data->roll }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger my-1">Delete</a>
